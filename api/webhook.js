...
const fixedPatterns = {
  "やる気": {
    ...
    response: `お疲れ様です😊 やる気アップでお悩みですね。お子さんのやる気について心配されるお気持ち、とてもよく分かります。\n\n✨ やる気向上のポイント\n1️⃣ 小さな成功体験を積む\n2️⃣ 適切な声かけを心がける\n3️⃣ 子どもの気持ちに寄り添う\n4️⃣ メリハリのある環境作り\n\n焦らずに、お子さんのペースを見守りながら進めていきましょう。専門家の具体的なアドバイスをご覧ください👇`,
...
function createWelcomeMessage() {
  ...
  return [{
    type: 'text',
    text: `🌸 中学受験相談AIへようこそ！\n\nお疲れ様です😊 中学受験でお悩みの保護者の方に寄り添う相談AIです。\n\n【対応講師】\n${educatorList}\n\n【よくあるご相談】\n📚 学習方法・暗記法\n📅 スケジュール管理\n🎯 志望校・塾選び\n😊 やる気・モチベーション\n👨‍👩‍👧‍👦 保護者のお悩み\n\nお子さんのことで心配なこと、不安なこと、どんなことでもお気軽にご相談ください。一緒に考えさせていただきます✨`,
    quickReply: {
